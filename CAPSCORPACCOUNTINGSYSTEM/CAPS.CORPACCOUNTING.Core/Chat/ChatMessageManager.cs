...
using CAPS.CORPACCOUNTING.Friendships;
using CAPS.CORPACCOUNTING.Friendships.Cache;

namespace CAPS.CORPACCOUNTING.Chat
{
    [AbpAuthorize]
    public class ChatMessageManager : CORPACCOUNTINGDomainServiceBase, IChatMessageManager
    {
