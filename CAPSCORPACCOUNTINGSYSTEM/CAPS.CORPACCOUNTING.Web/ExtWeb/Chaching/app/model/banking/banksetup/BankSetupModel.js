...
Ext.define('Chaching.model.banking.banksetup.BankSetupModel', {
    ...
    fields: [
        ...
        { name: 'typeOfBankAccountDesc', type: 'string' },
        { name: 'ledgerAccount', type: 'string' },
        { name: 'jobNumber', type: 'string' },
        { name: 'typeofCheckStockDesc', type: 'string' },
        { name: 'clearingAccountNumber', type: 'string' },
        { name: 'clearingJobNumber', type: 'string' },
        { name: 'typeOfUploadFileDesc', type: 'string' },
        { name: 'vendorNumber', type: 'string' },
        { name: 'controllingBankAccountDesc', type: 'string' },
