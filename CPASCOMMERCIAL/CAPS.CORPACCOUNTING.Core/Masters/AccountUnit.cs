...
{
    [Table("Accounts")]
    public sealed class AccountUnit : FullAuditedEntity<long>
    {
        /// <summary>
        ...
        public AccountUnit(string accountNumber, string balanceSheetName, string caption, string cashFlowName,
            int chartOfAccountId, string code, string description,
            int? displaySequence, long id, bool isActive, bool isApproved, bool isBalanceSheet, bool isCashFlow,
            bool isDescriptionLocked, bool isDocControlled, bool isElimination, bool isEnterable, bool isProfitLoss,
            bool isRollupAccount, bool isRollupOverridable, bool isSummaryAccount, bool isUs1120BalanceSheet,
            bool isUs1120IncomeStmt, int? linkAccountId, int? linkJobId, AccountUnit parent, long? parentId,
            string profitLossName, int? rollupAccountId, int? rollupJobId, int? typeOfAccountId,
            string us1120BalanceSheetName, string us1120IncomeStmtName)
        {
