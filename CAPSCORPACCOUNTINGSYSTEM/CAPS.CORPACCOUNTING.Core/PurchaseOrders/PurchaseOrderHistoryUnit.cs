...
namespace CAPS.CORPACCOUNTING.PurchaseOrders
{
    public enum ModificationType
    {
        ...
        Reopened = 8,
        [Display(Name = "VOID-Reduced")]
        VOIDReduced = 9,
        [Display(Name = "VOID-Line # change")]
        VOIDLinechange = 10,
        [Display(Name = "VOID-New Row Added")]
        VOIDNewRowAdded = 11,
        [Display(Name = "VOID-Increased Amount")]
        VOIDIncreasedAmount = 12,
        [Display(Name = "VOID-Decreased Amount")]
        VOIDDecreasedAmount = 13,
    ...
    public class PurchaseOrderHistoryUnit : CreationAuditedEntity<long>, IMustHaveTenant, IMustHaveOrganizationUnit
    {
        ...
        /// <summary>Gets or sets the ChangeInAmount field. </summary>
        public virtual decimal? ChangeInAmount { get; set; }
