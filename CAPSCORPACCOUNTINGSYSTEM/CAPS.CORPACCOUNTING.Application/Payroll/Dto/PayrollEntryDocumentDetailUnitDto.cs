...
{
    /// <summary>
    /// OutPutDto for PayrollEntryDocumentDetailUnit
    /// </summary>
    [AutoMapFrom(typeof(PayrollEntryDocumentDetailUnit))]
    public class PayrollEntryDocumentDetailUnitDto : AccountingItemUnitDto
    {
        ...
        /// <summary>Gets or sets the JobLocation field. </summary> 
