 ...
 */
Ext.define('Chaching.view.receivables.inquiry.InquiryGrid', {
    extend: 'Chaching.view.common.grid.ChachingGridPanel',
    xtype: 'receivables.inquiry.arinvoiceinquiry',
    name: 'Receivables.Inquiry.ARInvoiceInquiry',
    requires: [
    ...
    modulePermissions: {
        ...
        create: abp.auth.isGranted('Pages.Receivables.Inquiry.Create'),
        edit: abp.auth.isGranted('Pages.Receivables.Inquiry.Edit'),
        destroy: abp.auth.isGranted('Pages.Receivables.Inquiry.Delete')
    },
    gridId: 29,
    headerButtonsConfig: [
        {
            xtype: 'displayfield',
            value: abp.localization.localize("ARInvoiceInquiryGrid"),
            ui: 'headerTitle'
        }, '->'
    ],
    requireExport: true,
