...
Ext.define('Chaching.view.administration.companysetup.CompanySetupGrid', {
    extend: 'Chaching.view.common.grid.ChachingGridPanel',

    requires: [
        'Chaching.view.administration.companysetup.CompanySetupGridController'
    ],

    controller: 'administration-companysetup-companysetupgrid',
