            ...
            return new[]
                   {
                    ...
                    new SettingDefinition(AppSettings.UserManagement.ARAgingDate, ConfigurationManager.AppSettings[AppSettings.UserManagement.ARAgingDate]  ?? "0", scopes: SettingScopes.Tenant),
                    new SettingDefinition(AppSettings.UserManagement.APAgingDate, ConfigurationManager.AppSettings[AppSettings.UserManagement.APAgingDate]  ?? "0" , scopes: SettingScopes.Tenant),
                    ...
                    new SettingDefinition(AppSettings.UserManagement.APPostingDateDefault, ConfigurationManager.AppSettings[AppSettings.UserManagement.APPostingDateDefault] ?? "false", scopes: SettingScopes.Tenant),
