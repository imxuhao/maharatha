    ...
    appModule.controller('host.views.maintenance.index', [
        ...
        function ($scope, $window, cachingService, webLogService) {
            ...
            vm.clearAllCaches = function () {
                cachingService.clearAllCaches().success(function () {
            ...
            vm.getWebLogs = function () {
                webLogService.getLatestWebLogs({}).success(function (result) {
                    vm.logs = vm.getFormattedLogs(result.latesWebLogLines);
                    fixWebLogsPanelHeight();
                });
            };

            vm.downloadWebLogs = function () {
                webLogService.downloadWebLogs({}).success(function (result) {
